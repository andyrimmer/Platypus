...
extModules.append(Extension(name='variant', sources=['cython/variant.pyx'], include_dirs=incDirs, extra_compile_args=cFlags))
...
extModules.append(Extension(name='calign', sources=['cython/calign.pyx', 'c/align.c'], include_dirs=incDirs, extra_compile_args=cFlags))
extModules.append(Extension(name='chaplotype', sources=['cython/chaplotype.pyx', 'c/align.c'], include_dirs=incDirs, language='c', extra_compile_args=cFlags))
...
extModules.append(Extension(name='assembler', sources=corMods+['cython/assembler.pyx'], include_dirs=incDirs, extra_compile_args=cFlags, language='c'))
extModules.append(Extension(name='cgenotype', sources=corMods+['cython/cgenotype.pyx'], include_dirs=incDirs,  extra_compile_args=cFlags, language='c'))
extModules.append(Extension(name='platypusutils', sources=corMods+['cython/platypusutils.pyx'], include_dirs=incDirs,  extra_compile_args=cFlags, language='c'))
extModules.append(Extension(name='vcfutils', sources=corMods+['cython/vcfutils.pyx'], include_dirs=incDirs,  extra_compile_args=cFlags, language='c'))
extModules.append(Extension(name='cpopulation', sources=corMods+['cython/cpopulation.pyx'],  include_dirs=incDirs, extra_compile_args=cFlags, language='c'))
extModules.append(Extension(name='variantFilter', sources=corMods+['cython/variantFilter.pyx'], include_dirs=incDirs,  extra_compile_args=cFlags, language='c'))
extModules.append(Extension(name='variantcaller', sources=corMods+['cython/variantcaller.pyx'], include_dirs=incDirs,  extra_compile_args=cFlags, language='c'))
...
setup(name = "PlatypusCythonModules", ext_modules=cythonize(extModules,language_level=3), cmdclass = {'build_ext': build_pyx})
