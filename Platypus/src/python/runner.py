...
def callVariants(args):
    ...
    #parser.add_option("--printAlignments", dest="printAlignments", help="If 1, then alignments of reads to haplotypes will be printed to the log file", action='store', type='int', default=0)
    ...
    #parser.add_option("--cacheOffsets", dest="cacheOffsets", help="If this is set to 1, then all BAM index look-ups will be done at the beginning of each process, and cached.", type='int', action='store', default=0)
    ...
    #parser.add_option("--useIndelErrorModel", dest="useIndelErrorModel", help="If set to 1, the new indel error model will be used", action='store', type='int', default=0)
