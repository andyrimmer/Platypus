...
extModules.append(Extension(name='samtoolsWrapper', sources=['samtoolsWrapper.c', 'pysam_util.c'] + glob.glob(os.path.join("samtools", "*.c")), include_dirs=["samtools", "./"], libraries=['z'], language='c', extra_compile_args=cFlags))
...
extModules.append(Extension(name='platypusutils', sources=['platypusutils.c'], include_dirs=["samtools"],  extra_compile_args=cFlags))
extModules.append(Extension(name='cgenotype', sources=['cgenotype.c'], include_dirs=["samtools"],  extra_compile_args=cFlags))
extModules.append(Extension(name='vcfutils', sources=['vcfutils.c'], include_dirs=["samtools"],  extra_compile_args=cFlags))
extModules.append(Extension(name='cpopulation', sources=['cpopulation.c'],  include_dirs=["samtools"], extra_compile_args=cFlags))
extModules.append(Extension(name='cwindow', sources=['cwindow.c'], include_dirs=["samtools"],  extra_compile_args=cFlags))
extModules.append(Extension(name='vcfutils', sources=['vcfutils.c'], include_dirs=["samtools"],  extra_compile_args=cFlags))
